...
<body class="img js-fullheight" style="background-image: url(../images/bg.jpg);">
  ...
  <div class="collapse navbar-collapse " id="navbarTogglerDemo02">
    <ul class="nav nav-tabs">
      ...
      <li class="nav-item">
      <a class="nav-link active" aria-current="page"href="<?php echo BASE_URL; ?>client/client" class="nav-link"><p class="text-warning">Client</p></a>
      </li>
      <li class="nav-item"  >
               ...
               <?php include('./views/includes/alert.php'); ?> 
                    <div class="card">
                        <div class=" car-body  bg-light p-4">
                            <!-- <a href="<?php echo BASE_URL; ?>client/add"> <button class="btn btn-sm btn-warning "> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z" />
                                    </svg> </button> </a> -->
                            <!-- <a href="<?php echo BASE_URL; ?>client/client"> <button class="btn btn-sm btn-warning"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-fill" viewBox="0 0 16 16">
